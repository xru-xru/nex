const SvgBdEndOfMonth = (props) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#bd-end-of-month_svg__a)">
      <path fill="#674CED" fillOpacity={0.16} d="M50.398 5h-14.4v24h14.4z" />
    </g>
    <g filter="url(#bd-end-of-month_svg__b)">
    ...
    <defs>
      ...
      >
        ...
        <feBlend in2="shape" result="effect1_innerShadow_9720_114814" />
      </filter>
      <filter
        id="bd-end-of-month_svg__b"
        x={52.398}
        y={5}
        width={14.398}
        height={24}
...
export default SvgBdEndOfMonth;
